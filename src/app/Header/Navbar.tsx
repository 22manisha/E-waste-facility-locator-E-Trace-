...
import logo from "../../assets/newblue.png"
  ...
  return (
    <header className={`header ${isHeaderActive ? "active" : ""}`} data-header>
      <div className="container shadow-md">
        ...
        <h1 className='font-montserrat font-bold text-xl ml-12 md:ml-4 md:text-2xl' style={{ color: 'rgb(0%, 40%, 58%)' }}>
     <IonIcon icon={location} aria-hidden="true" role="img"></IonIcon>{locations || 'Loading...'}
     </h1>
