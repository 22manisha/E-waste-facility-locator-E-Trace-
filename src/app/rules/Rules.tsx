  ...
  return (
    <div className="flex flex-col section  container">
      <div className="w-full mx-auto text-2xl px-4">
        ...
        <h2 className="text-3xl text-blue-600 font-bold mb-4" style={{ color: 'rgb(0%, 40%, 58%)' }}>
          Latest Indian Government E-Waste Management Rules
        </h2>
        <p className="mb-2"></p>
        <p className="mb-2">
        ...
        <p className="mb-2">
          <strong>Dated the 8th March, 2024</strong>
        </p>
        <p className="mb-2">
          <strong>G.S.R. 164(E)</strong>
        </p>
        <p className="mb-2">
          <strong>Subject: The E-Waste (Management) Rules, 2024</strong>
        </p>
        <p className="mb-4">
...
Government hereby makes the following rules further to amend the E-Waste (Management) Rules, 2022, namely: -
        ...
        <h3 className="text-3xl font-bold mb-2 text-blue-600" style={{ color: 'rgb(0%, 40%, 58%)' }}>CHAPTER I</h3>
        <p className="mb-2">
        ...
        <p className="mb-2">
          (1) These rules may be called the E-Waste (Management) Rules, 2024.
        </p>
        <p className="mb-2">
        ...
        <h3 className="text-3xl font-bold mb-2 text-blue-600" style={{ color: 'rgb(0%, 40%, 58%)' }}>CHAPTER II</h3>
        <p className="mb-2">
        ...
        <p className="mb-2">
          <strong>9A. Relaxation of timelines for filing of returns.</strong>
        </p>
        <p>
          (1) The Central Government can extend filing deadlines for reports on electrical and electronic equipment if it's deemed necessary for public interest or effective rule implementation.
        </p>
        <p>
          (2) The extension period granted cannot exceed nine months.
        </p>
      ...
      <div className="flex flex-col md:flex-row w-full mx-auto md:w-full md:max-h-140 max-h-[130rem] gap-10 md:mt-24 px-4">
        ...
        <div className="flex flex-col w-full my-4 projects shadow-lg bg-gray-400 border border-gray-500 overflow-y-auto p-8">
        <h2 className="text-3xl text-blue-600 font-bold mb-4" style={{ color: 'rgb(0%, 40%, 58%)' }}>
          E waste Annual Report for Uttar Pradesh
          </h2>
